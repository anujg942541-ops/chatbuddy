...
st.set_page_config(
    page_title="Document analyser -  Document Assistant",
    page_icon="🏥",
    layout="wide",
...
<div style="text-align: center; padding: 2rem 0;">
    <h1 style="color: #ff4b4b; font-size: 3rem; margin-bottom: 0.5rem;">🏥 Document Pro</h1>
...
with st.sidebar:
    ...
    uploaded_files = pdf_uploader() #invoke this function 
        ...
        if st.button("🚀 Process Documents", type="primary"):
            with st.spinner("Processing your documents..."):
                ...
                for file in uploaded_files:
                    text = extract_text_from_pdf(file) #invoke this function 
